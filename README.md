...
Escaneo de código QR en el contenedor (uno por contenedor; si el punto de reciclaje los tiene separados por material, el QR ya dice el material), selección del material (papel/cartón, plástico, vidrio, metal) y del tamaño de la bolsa (S, M, L o XL). No se pide el peso: la app estima los kilos según material y talla. El proceso no debe superar los 30 segundos.
